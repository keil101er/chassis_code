...
extern uint8_t ui_g_max_send_count[16];
...
#define ui_g_Ungroup_AutoShootRegion ((ui_interface_rect_t *)&ui_g_now_figures[11])
#define ui_g_Ungroup_power_value ((ui_interface_number_t *)&ui_g_now_figures[12])
