...
#define  CHASSIS_X_RIGHT_COMPENSATION 0.22f  
...
#define RECOVER_PITCH_ANGLE_LIMIT               (3.1415926f / 2.0f)
#define RECOVER_PITCH_EXIT_ANGLE_THRESHOLD      (3.1415926f / 15.5f)
#define RECOVER_PITCH_GYRO_THRESHOLD            3.0f
#define RECOVER_PITCH_DETECT_COUNT_THRESHOLD    20
#define RECOVER_GYRO_DETECT_COUNT_THRESHOLD     10
#define RECOVER_RELEASE_COUNT_THRESHOLD         25
#define RECOVER_DISABLE_HOLD_COUNT_THRESHOLD    100
...
#define WZ_PID_KP 15.0f
#define WZ_PID_KI 0.0f 
#define WZ_PID_KD 2.5f
//#define TURN_PID_KP 0.0f
//#define TURN_PID_KI 0.0f 
//#define TURN_PID_KD 0.0f
//Rated torque of the wheel hub motor
