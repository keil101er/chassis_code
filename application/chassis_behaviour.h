...
typedef enum
{
  CHASSIS_ZERO_FORCE,        //底盘无力, 跟没上电一样
  CHASSIS_BALANCE,          //
  CHASSIS_INFANTRY_FOLLOW_GIMBAL_YAW,     //底盘跟随云台   一起转动
// CHASSIS_ENGINEER_FOLLOW_CHASSIS_YAW,  //

	CHASSIS_NO_FOLLOW_YAW,//小陀螺
...
extern void chassis_behaviour_control_set( fp32 *v_set, fp32 *turn_set, chassis_t *chassis_move_rc_to_vector);


extern void chassis_remote_control(fp32 *v_set, fp32 *turn_set, chassis_t *chassis_move_rc_to_vector);


extern void chassis_down_control( chassis_t *chassis_move_state);

extern void chassis_zero_force_control(chassis_t *chassis_move_rc_to_vector);
